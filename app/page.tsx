  ...
  const testimonials = [
    {
      ...
      content:
        "EcoCity helped me reduce my carbon footprint by 40% in just 3 months!",
    ...
    },
    {
      ...
      role: "Urban Planner",
      content:
        "The AI recommendations are spot-on. I've saved $200 on utilities this year.",
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 5,
    },
    {
      ...
      content:
        "Love the community challenges! They make sustainability fun and engaging.",
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 5,
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "AI-powered route optimization for sustainable transportation choices",
      color: "blue",
    },
    {
      icon: Recycle,
      ...
      description:
        "Track, analyze, and reduce your waste with personalized insights",
      color: "green",
    },
    {
      icon: Zap,
      ...
      description:
        "Monitor consumption and discover energy-saving opportunities",
      color: "yellow",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Visualize your environmental impact with detailed analytics",
      color: "indigo",
    },
    {
      icon: Award,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/waste" className="text-gray-700 hover:text-green-600 font-medium transition-colors">
                Waste
              </Link>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Join thousands of eco-conscious citizens using AI-powered
                  insights to reduce their environmental impact, save money, and
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI-powered platform provides comprehensive tools to track,
              analyze, and improve your environmental impact.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Compete with neighbors, earn rewards, and make a collective impact
              on your city's sustainability.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Loved by eco-conscious citizens
            </h2>
            <p className="text-xl text-gray-600">
              See how EcoCity is helping people make a real difference
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join thousands of people already using EcoCity to build a more
            sustainable future. Start your journey today.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-5 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                ...
                AI-powered insights and collective action.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2024 EcoCity. All rights reserved.
            </p>
